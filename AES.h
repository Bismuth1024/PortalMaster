...
public:
  ...
  void EncryptECB(unsigned char in[16], unsigned int inLen, unsigned  char key[], unsigned int outLen);

  void DecryptECB(unsigned char in[16], unsigned int inLen, unsigned  char key[]);
